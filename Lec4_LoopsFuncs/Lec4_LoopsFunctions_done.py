...
water = [random.choices(['municipal', 'private'], weights = [0.6, 0.4])[0] for h in household]
print(water)
...
def hello_name(age, name = 'Rosa'): 
    print("Hello " + name + ", and I am " + str(age) + " years old!")

hello_name(27)

hello_name(name = "Santa", age = 782)
hello_name(782, 'Santa')
...
def fibonacci_under_threshold(threshold):
    ...
    return fib, threshold, [fib]*2

f200, f200_thres, f2001 = fibonacci_under_threshold(200)
#print(f200)
#print()
